...
import {
  ...
  CheckCircle2, ShieldCheck, Clock, MessageSquare, Home as HomeIcon, Sofa,
} from 'lucide-react';
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={s.label} className="card p-4">
                ...
                <div className="mt-2 text-lg font-bold text-slate-900 dark:text-white">{s.value}</div>
        ...
        <aside className="space-y-4 lg:sticky lg:top-20 lg:self-start">
          <div className="card p-6">
            ...
            <div className="mt-5 space-y-2 border-t border-slate-100 pt-4 text-sm dark:border-slate-800">
              <p className="flex items-center gap-2 text-slate-600 dark:text-slate-300"><ShieldCheck className="h-4 w-4 text-brand-600" /> Verified listing</p>
